...
# weatherapp
A Restful api built on nodejs, express, body-parser, ejs and mongoose..


## Installation

The code for the chat app can be found at the public [GitHub](https://github.com/olawuwo-abideen/restfulapi). Either clone the repo to a local folder on your machine or
